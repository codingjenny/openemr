                                    ...
                                    if (!$userMode || in_array($grpname, $USER_SPECIFIC_TABS)) {
                                        ...
                                        foreach ($grparr as $fldid => $fldarr) {
                                            if (!$userMode || in_array($fldid, $USER_SPECIFIC_GLOBALS)) {
                                                ...
                                                } elseif ($fldtype == 'cds_hooks_services') {
                                                    // Special type for CDS Hooks service discovery and management
                                                    if ($userMode) {
                                                        $globalTitle = $globalValue;
                                                    }
                                                    echo "<input type='hidden' name='form_$i' value='" . attr($fldvalue) . "' />";
                                                    echo "<div id='cds_hooks_services_section'>";
                                                    echo "<h5>" . xlt('CDS Hooks Services') . "</h5>";
                                                    echo "<div class='row mb-3'>";
                                                    echo "<div class='col-sm-6'>";
                                                    echo "<button type='button' class='btn btn-primary btn-sm' onclick='discoverCDSServices()'>";
                                                    echo "<i class='fas fa-search'></i> " . xlt('Discover Services');
                                                    echo "</button>";
                                                    echo "</div>";
                                                    echo "<div class='col-sm-6'>";
                                                    echo "<button type='button' class='btn btn-info btn-sm' onclick='loadCDSServices()'>";
                                                    echo "<i class='fas fa-refresh'></i> " . xlt('Refresh Services');
                                                    echo "</button>";
                                                    echo "</div>";
                                                    echo "</div>";
                                                    echo "<div id='cds_services_list'>";
